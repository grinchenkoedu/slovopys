        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td><input type="text" size="64" name="sowp_facebook"
                               value="<?php echo esc_attr(get_option('sowp_facebook')); ?>" placeholder="http://"/></td>
                </tr>

                <tr valign="top">
                    <th scope="row">YouTube</th>
                    <td><input type="text" size="64" name="sowp_youtube"
                               value="<?php echo esc_attr(get_option('sowp_youtube')); ?>" placeholder="http://"/></td>
                </tr>

                <tr valign="top">
                    <th scope="row">Instagram</th>
                    <td><input type="text" size="64" name="sowp_insta"
                               value="<?php echo esc_attr(get_option('sowp_insta')); ?>" placeholder="http://"/></td>
                </tr>

                <tr valign="top">
                    <th scope="row">Google+</th>
                    <td><input type="text" size="64" name="sowp_gplus"
                               value="<?php echo esc_attr(get_option('sowp_gplus')); ?>" placeholder="http://"/></td>
                </tr>

                <tr valign="top">
                    <th scope="row">Код в head</th>
                    <td><textarea cols="128" rows="16"
                                  name="sowp_head"><?php echo get_option('sowp_head'); ?></textarea></td>
                </tr>

                <tr valign="top">
                    <th scope="row">Код в footer</th>
                    <td><textarea cols="128" rows="16"
                                  name="sowp_footer"><?php echo get_option('sowp_footer'); ?></textarea></td>
                </tr>
            </table>
